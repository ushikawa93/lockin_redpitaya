...
archivo_adc = "../barrido_en_f_R680_c10n_pasa_altos.dat";
...
archivo_sr865 =  "../r680_c10n_sr865_2.dat";
...
axes('Position', [0.18, 0.72, 0.25, 0.15]); % Ajusta la posición y el tamaño del zoom
box on;
...
ylim([0.69 0.77]); % Ajusta los límites de Y según sea necesario
...
axes('Position', [0.18, 0.2, 0.25, 0.15]); % Ajusta la posición y el tamaño del zoom
box on;
...
xlim([fcorte * 0.96, fcorte * 1.03]); % Ajusta la ventana de zoom alrededor de fcorte
ylim([38 47]); % Ajusta los límites de Y según sea necesario
title("Zoom en fase");
